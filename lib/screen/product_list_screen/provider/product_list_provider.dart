...
class ProductListProvider extends ChangeNotifier {
  ...
  getProductsByQuery(String query) async {
    ...
    _queryText = query;
    await this._dataProvider.getProductsPaginationByQuery(page: _page, query: query).then((data){
      print(data);
      _allProducts.addAll(data);
    });
    print(_page);
  ...
  getFavoriteProducts(List<String> ids) async {
    ...
    await this._dataProvider.getFavoriteProducts(ids: ids, page: _page).then((data){

                        ...
                        child: Column(
                          children: [
                            ...
                            CustomTextField(
                              ...
                              validator: (value) =>
                                  value!.isEmpty ? 'Digite a rua' : null,
                            ),
                            CustomTextField(
                              height: 65,
                              labelText: 'Cidade',
                              ...
                              validator: (value) =>
                                  value!.isEmpty ? 'Digite a cidade' : null,
                            ),
                            CustomTextField(
                              height: 65,
                              labelText: 'Estado',
                  ...
                  child: Consumer<CartProvider>(
                    builder: (context, cartProvider, child) {
                      return Column(
                        ...
                        children: [
                          Text(
                              'SubTotal             : ${NumberFormat.simpleCurrency(locale: 'pt_BR').format(cartProvider.getCartSubTotal())}',
                              style: const TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black)),
                          Text(
                              'Desconto Total Aplicado  : ${NumberFormat.simpleCurrency(locale: 'pt_BR').format(cartProvider.couponCodeDiscount)}',
                              style: const TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black)),
                          Text(
                              'Valor Final            :  ${NumberFormat.simpleCurrency(locale: 'pt_BR').format(cartProvider.getGrandTotal())}',
                              style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: AppColor.abobora)),
                        ],
                      );
                    },
                  ),
                ...
                Consumer<CartProvider>(
                  builder: (context, cartProvider, child) {
                    return CompleteOrderButton(
                        labelText:
                            'Finalizar Pedido   ${NumberFormat.simpleCurrency(locale: 'pt_BR').format(cartProvider.getGrandTotal())}',
                        onPressed: () {
